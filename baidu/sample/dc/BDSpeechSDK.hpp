...
namespace bds {
    ...
    public:
        ...
        virtual void set_event_listener(void(*listener)(bds::BDSSDKMessage&,void*), void* userParam) = 0;
        static void release_instance(BDSpeechSDK* instance);

        virtual bool post(bds::BDSSDKMessage &message, std::string &outErrorDescription) = 0;
        /*
